...
public class LabyrintheGameView extends View {
    ...
    public LabyrintheGameView(Context context) {
        super(context);
    ...
    public void setLabyrinthe(Labyrinthe labyrinthe) {
        ...
        mazeFinishX = labyrinthe.getFinalX();
        mazeFinishY = labyrinthe.getFinalY();
        mazeSizeX = labyrinthe.getMazeWidth();
        mazeSizeY = labyrinthe.getMazeHeight();
        hLines = labyrinthe.getHorizontalLines();
        vLines = labyrinthe.getVerticalLines();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int currentX = labyrinthe.getCurrentX(),currentY = labyrinthe.getCurrentY();
        //draw the ball
    ...
    public boolean onKeyDown(int keyCode, KeyEvent evt) {
        ...
        switch(keyCode) {
            case KeyEvent.KEYCODE_DPAD_UP:
                moved = labyrinthe.move(Labyrinthe.UP);
                break;
            case KeyEvent.KEYCODE_DPAD_DOWN:
                moved = labyrinthe.move(Labyrinthe.DOWN);
                break;
            case KeyEvent.KEYCODE_DPAD_RIGHT:
                moved = labyrinthe.move(Labyrinthe.RIGHT);
                break;
            case KeyEvent.KEYCODE_DPAD_LEFT:
                moved = labyrinthe.move(Labyrinthe.LEFT);
                break;
            default:
    ...
    void showFinishDialog() {
        ...
        View view = inflater.inflate(R.layout.activity_labyrinthe_finish, null);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        int currentX = labyrinthe.getCurrentX();
        int currentY = labyrinthe.getCurrentY();
